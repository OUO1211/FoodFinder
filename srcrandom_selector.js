...
function findWasmBinary() {
  return locateFile('srcrandom_selector.wasm');
}
...
var _getRandomIndex = Module['_getRandomIndex'] = makeInvalidEarlyAccess('_getRandomIndex');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['getRandomIndex'] != 'undefined', 'missing Wasm export: getRandomIndex');
  ...
  _initialize = Module['_initialize'] = createExportWrapper('initialize', 1);
  _getRandomIndex = Module['_getRandomIndex'] = createExportWrapper('getRandomIndex', 0);
